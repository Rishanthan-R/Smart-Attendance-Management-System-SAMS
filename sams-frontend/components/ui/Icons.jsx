...
export function IconLocation({ size = 18, className = "" }) {
  return (
...
export function IconMobile({ size = 18, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function IconArrow({ size = 14, className = "" }) {
  return (
...
export function IconDiamond({ size = 10, className = "" }) {
  return (
...
export function IconStar({ size = 10, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
...
/* ─── Extra Icons for dashboard features ────────────────────────── */
